...
class VisaAPIClient(Utilities):
    ...
    def do_mutual_auth_request(
        ...
        user_name = self.cf.visa_userid
        password = self.cf.visa_password
        cert = self.cf.visa_cert
        key = self.cf.visa_key
        end_point = self.cf.visa_url
        url = end_point + path
        response = {}
    ...
    def do_x_pay_request(
        ...
        shared_secret = self.cf.visa_shared_secret
        end_point = self.cf.visa_url
