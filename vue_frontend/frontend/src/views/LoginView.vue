<template>
    <div>
                    ...
                    <td rowspan="3">
                        <div class="container" id="g_id">
                            <div class="row justify-content-center">
                                <div class="col">
                                    <a id="google_img" @mouseover="hideCreateuser('add_entry')" class="btn btn-outline-dark"
                                        href="javascript:void(0)" onclick="getGoogleToken()" role="button"
                                        style="text-transform: none">
                                        <img :src="'./images/gg.png'" class="google" v-bind:alt="'Google'" />
                                        Login with Google
                                    </a>
                                    <a id="msoft" @mouseover="hideCreateuser('add_entry')" class="btn btn-outline-dark"
        ...
        <div id="add_entry" style="display: none">
            <div class="close">
                <a href="javascript:void(0)" @click="hideCreateuser('add_entry')"><i class="fa fa-remove"></i></a>
            </div>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <input id="b2" type="button" value="Cancel" v-on:click="hideCreateuser('add_entry')"
                            style="width: 100%" />
                    </td>
                </tr>
            </table>
        ...
        <button class="form-btn" @click="showCreateUser('add_entry')" type="button" id="add_p">
...
import { hide_add_entry, show_add_entry } from "@/helpers/script.js";
        ...
        async login() {
            ...
            if (userName != "" || passWord != "") {
                ...
                document.getElementById("info").innerHTML =
                    "<strong>Wrong!</strong> " + " Empty fields!";
            }
        },
        showCreateUser(id) {
            show_add_entry(id);
